...
function Index() {
  ...
  const getInfo = async () => {
    ...
    const res = await fetch(`http://ec2-54-180-133-86.ap-northeast-2.compute.amazonaws.com/api/info?name=${PropTitle}`, {
      method: 'GET',
      headers: {
  ...
  const addWish = async (id: string) => {
    if (sessionStorage.getItem('Email') != '' && sessionStorage.getItem('Email') != null) {
      const res = await fetch(`http://ec2-54-180-133-86.ap-northeast-2.compute.amazonaws.com/api/db/wish?act=add&id=${id}&email=${sessionStorage.getItem('Email')}`, {
        method: 'GET',
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const addWatched = async (id: string) => {
    if (sessionStorage.getItem('Email') != '' && sessionStorage.getItem('Email') != null) {
      const res = await fetch(`http://ec2-54-180-133-86.ap-northeast-2.compute.amazonaws.com/api/db/watched?act=add&id=${id}&email=${sessionStorage.getItem('Email')}`, {
        method: 'GET',
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const getDaily = async () => {
    const res = await fetch('http://ec2-54-180-133-86.ap-northeast-2.compute.amazonaws.com/api/daily', {
      method: 'GET',
      headers: {
          "Content-Type": "application/json",
      },
